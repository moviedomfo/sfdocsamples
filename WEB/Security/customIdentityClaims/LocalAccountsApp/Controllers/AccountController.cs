...
using LocalAccountsApp.app_identity;
...
namespace LocalAccountsApp.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<ManageInfoViewModel> GetManageInfo(string returnUrl, bool generateState = false)
        {
            ...
            ApplicationUser user = await UserManager.FindByIdAsync(guid);
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            var guid = Guid.Parse(User.Identity.GetUserId());
            IdentityResult result = await UserManager.AddLoginAsync(guid,                new UserLoginInfo(externalData.LoginProvider, externalData.ProviderKey));
        ...
        public async Task<IHttpActionResult> RemoveLogin(RemoveLoginBindingModel model)
        {
            ...
            if (model.LoginProvider == LocalLoginProvider)
            {
                    ...
                    result = await UserManager.RemovePasswordAsync(guid);
            }
            else
            {
                result = await UserManager.RemoveLoginAsync(guid,new UserLoginInfo(model.LoginProvider, model.ProviderKey));
            }
