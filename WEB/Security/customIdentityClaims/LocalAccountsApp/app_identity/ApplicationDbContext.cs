...
namespace LocalAccountsApp.app_identity
{
    ...
    public class ApplicationUserStore : UserStore<ApplicationUser, ApplicationRole, Guid, ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim>, IUserStore<ApplicationUser, Guid>, IDisposable
    {
    ...
    /// 
    /// </summary>
    public class ApplicationRoleStore : RoleStore<ApplicationRole, Guid, ApplicationUserRole>, IQueryableRoleStore<ApplicationRole, Guid>, IRoleStore<ApplicationRole, Guid>, IDisposable
    {
