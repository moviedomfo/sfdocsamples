...
namespace LocalAccountsApp.app_identity
{
    ...
    public class ApplicationGroupStore : IDisposable
    {
        ...
        public ApplicationGroup FindById(Guid roleId)
        {
            this.ThrowIfDisposed();
    ...
    //Mimicking EntityStore 
    //Basicamente trata de representar la clase interna de EntityStore para usuarios y roles
