...
namespace SportsClub.DAC
{
    public class PersonDAC
    {
        ...
        public static List<PersonFullViewBE> Retrive()
        {
            ...
            String strJson = Fwk.HelperFunctions.FileFunctions.OpenTextFile(@"C:\projects\GitHub-sourcetree\doc_samples\WEB\angular-ng\angularTest3\angularTest3\App_Data\persons.json");
