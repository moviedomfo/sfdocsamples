    ...
    public class EmployeesBEList : Entities<EmployeBE> 
    {
        public static EmployeesBEList Factory()
        {
            try
            {
                ...
                var xmlEmp = Fwk.HelperFunctions.FileFunctions.OpenTextFile(@"C:\projects\GitHub-sourcetree\doc_samples\WEB\angular-ng-table-Test\angularTest2\bin\App_Data\Employees.xml");
