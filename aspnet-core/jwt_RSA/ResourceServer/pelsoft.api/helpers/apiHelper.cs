...
namespace pelsoft.api.helpers
{
    ...
    public class apiHelper
    {
        ...
        //        //using (var impersonation = new ImpersonateUser(apiConfig.pelsoftFolderSettings.user, apiConfig.domain, apiConfig.serviceConfig.pelsoftFolderSettings.password, ImpersonateUser.LOGON32_LOGON_NEW_CREDENTIALS))
        //        //{
        //        //    StaticLogger.Log(TargetType.Xml, ev, fullFileName, string.Empty);
        ...
        //            ev.AppId = wapiAppSettings.serviceName;
        //        //else
        //        //    ev.AppId = "pelsoft service : tu recibo web";
        //    ev.Message.Text = Fwk.Exceptions.ExceptionHelper.GetAllMessageException(ex);
        //    ev.LogDate = System.DateTime.Now;
        //    Log_FileSystem(ev);
